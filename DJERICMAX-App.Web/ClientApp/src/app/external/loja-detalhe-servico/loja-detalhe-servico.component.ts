...
@Component({
  selector: "app-loja-detalhe-servico",
  templateUrl: "./loja-detalhe-servico.component.html",
  styleUrls: ["./loja-detalhe-servico.component.scss"],
})
export class LojaDetalheServicoComponent implements OnInit {
